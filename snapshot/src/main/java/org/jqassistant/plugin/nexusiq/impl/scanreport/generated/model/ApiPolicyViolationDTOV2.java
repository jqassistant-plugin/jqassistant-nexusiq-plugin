 ...
 */
@JsonPropertyOrder({
    ApiPolicyViolationDTOV2.JSON_PROPERTY_CONSTRAINT_VIOLATIONS,
    ApiPolicyViolationDTOV2.JSON_PROPERTY_POLICY_ID,
    ApiPolicyViolationDTOV2.JSON_PROPERTY_POLICY_NAME,
    ApiPolicyViolationDTOV2.JSON_PROPERTY_POLICY_VIOLATION_ID,
    ApiPolicyViolationDTOV2.JSON_PROPERTY_THREAT_LEVEL
})
...
public class ApiPolicyViolationDTOV2 {
    ...
    public ApiPolicyViolationDTOV2() {
    }

    public ApiPolicyViolationDTOV2 constraintViolations(List<ApiConstraintViolationDTO> constraintViolations) {
        this.constraintViolations = constraintViolations;
        return this;
    }

    public ApiPolicyViolationDTOV2 addConstraintViolationsItem(ApiConstraintViolationDTO constraintViolationsItem) {
    ...
    public ApiPolicyViolationDTOV2 policyId(String policyId) {
    ...
    public ApiPolicyViolationDTOV2 policyName(String policyName) {
    ...
    public ApiPolicyViolationDTOV2 policyViolationId(String policyViolationId) {
    ...
    public ApiPolicyViolationDTOV2 threatLevel(Integer threatLevel) {
    ...
    /**
     * Return true if this ApiPolicyViolationDTOV2 object is equal to o.
     */
    @Override
    public boolean equals(Object o) {
        ...
        ApiPolicyViolationDTOV2 apiPolicyViolationDTOV2 = (ApiPolicyViolationDTOV2) o;
        return Objects.equals(this.constraintViolations, apiPolicyViolationDTOV2.constraintViolations) &&
            Objects.equals(this.policyId, apiPolicyViolationDTOV2.policyId) &&
            Objects.equals(this.policyName, apiPolicyViolationDTOV2.policyName) &&
            Objects.equals(this.policyViolationId, apiPolicyViolationDTOV2.policyViolationId) &&
            Objects.equals(this.threatLevel, apiPolicyViolationDTOV2.threatLevel);
    }

    @Override
    public int hashCode() {
        return Objects.hash(constraintViolations, policyId, policyName, policyViolationId, threatLevel);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ApiPolicyViolationDTOV2 {\n");
